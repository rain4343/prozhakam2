  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">High-level metrics across the organization.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card className="lg:col-span-1">
          <CardHeader>
            ...
            <CardDescription>Current state of all tracked items</CardDescription>
          </CardHeader>
          <CardContent>
              ...
              {stats.assetsByStatus.map((statusItem) => (
                <div key={statusItem.status} className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="capitalize font-medium">{statusItem.status.replace('-', ' ')}</span>
                  </div>
            ...
            {deptStats && deptStats.length > 0 && (
              <div className="mt-8">
                <h4 className="text-sm font-semibold mb-4">By Department</h4>
                <div className="space-y-4">
                  {deptStats.map(ds => (
